...
const messages: Record<Lang, Record<Key, string>> = {
    ...
    ru: {
        ...
        product_info:
            '📦 <b>Товар:</b> {title}\n🎁 <b>Бонус за покупку и отзыв: +{bonus} баллов</b>\n\n{channelWarn}<b>Порядок выполнения:</b>\n\n1. Перейдите в Uzum Market по кнопке ниже.\n2. Оставьте 5 звёзд (⭐⭐⭐⭐⭐) и напишите положительный отзыв.\n3. Отправьте скриншот отзыва в бот.',
        channel_warning:
    ...
    en: {
        ...
        product_info:
            '📦 <b>Product:</b> {title}\n🎁 <b>Bonus for purchase & review: +{bonus} points</b>\n\n{channelWarn}<b>How to complete:</b>\n\n1. Go to Uzum Market via the button below.\n2. Leave 5 stars (⭐⭐⭐⭐⭐) and write a positive review.\n3. Send a screenshot of your review to the bot.',
        channel_warning:
